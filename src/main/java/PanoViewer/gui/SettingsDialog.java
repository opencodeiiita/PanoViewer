...
public class SettingsDialog extends JPanel {
    ...
    private JTabbedPane SettingsDialog = new JTabbedPane();
    ...
    public SettingsDialog() {
        ...
        SettingsDialog.add("General Look", themesPanel);
        this.setLayout(new BorderLayout());
        add(SettingsDialog, BorderLayout.NORTH);
